    ...
    <div>
        ...
        <v-row>
            <v-col cols=4 class="text-center">
                ...
                >
                    <div class="py-2 ma-n2 text-center title" style="backgroundColor: #C5F1FF">
                        ...
                        <v-row class="mt-6">
                            <v-col cols=6 align-self="center">
                                <v-row align="center">
                                    ...
                                    <v-col>
                                        <div class="black--text text-left caption">
                                            Créditos Gerados
                                        </div>
                                    </v-col>
                                </v-row>
                            ...
                            <v-col cols=6 class="pt-6 pr-4">
                                <v-row align="center" class="fill-height">
                                    <v-col>
                                        <img height="150px" src="/invoice_example.png" alt="invoice_example">
                                    </v-col>
                                </v-row>
                            </v-col>
                        </v-row>
            ...
            <v-col cols=8>
                <v-card
                    ...
                    height="300px"
                >
                    <v-row class="ma-n2 text-center" style="backgroundColor: #D9D9D9">
                        <v-col cols=6>
                    ...
                    <v-row class="mt-0 px-3">
                        <v-col align-self="center" cols=2>
                            <v-row
                                ...
                                :style="`height: 130px; backgroundColor: ${tab == 0 ? '#B9B7B7' : '#D9D9D9'}; cursor: pointer; border-radius: 3px 0px 0px 0px`"
                                @click="tab = 0"
                            >
                            ...
                            <v-row
                                class="px-1 py-6 text-center"
                                :style="`height: 130px; backgroundColor: ${tab == 1 ? '#B9B7B7' : '#D9D9D9'}; cursor: pointer; border-radius: 0px 0px 0px 3px`"
                                @click="tab = 1"
                            >
                                <v-col align-self="center">
                                    Dados da UC
                        ...
                        <v-col v-if="tab == 0" cols=10>
                            <v-row
                                ...
                                class="text-center"
                            >
                                <v-col cols=3 style="height: 130px" v-for="item in invoiceData" v-bind:key="item.name">
                                    <v-row class="pt-4 text-center">
                                        <v-col class="py-1 subtitle-2">    
                                            {{ item.name }}
                                        </v-col>
                                    </v-row>
                                    <v-row class="font-weight-black text-center  subtitle-2">
                                        <v-col class="py-1">    
                                            {{ item.value }}
                                        </v-col>
                                    </v-row>
                        ...
                        <v-col v-if="tab == 1" cols=10>
                            <v-row
                                ...
                                class="text-center"
                            >
                                <v-col cols=3 style="height: 130px" v-for="item in ucData" v-bind:key="item.name">
                                    <v-row class="pt-4 text-center">
                                        <v-col class="py-1  subtitle-2">    
                                            {{ item.name }}
                                        </v-col>
